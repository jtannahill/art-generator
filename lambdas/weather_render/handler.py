...
ARTIST_PROFILES = {
    ...
    "arshile_gorky": {
        "description": "Arshile Gorky — biomorphic surrealism hovering between figuration and abstraction. Organic forms that suggest bodies, landscapes, and inner worlds simultaneously. Thin translucent washes overlaid by dense, tortured brushwork. Forms dissolve at their edges, part organism, part memory, part dream. Anguished yet lyrical — the last Surrealist, the first Abstract Expressionist.",
        "weather_mapping": "Humidity drives biomorphic ambiguity — high humidity = forms bleeding into one another, shapes dissolving at edges. Temperature anomaly maps to emotional charge — large anomaly = more tortured, distorted forms pressing against the surface; mild anomaly = lyrical floating shapes drifting freely. Wind creates gestural energy — strong wind = aggressive impasto marks forcing through thin washes below. Pressure maps to spatial depth — low pressure = compressed claustrophobic forms; high pressure = forms floating in open painterly space. Precipitation adds thin washes that dissolve underlying structure.",
        "negative": "NOT geometric, NOT clean-edged, NOT illustrative, NOT photorealistic, NOT decorative. Forms should hover between recognizable and abstract — never fully resolved in either direction. NOT cheerful or pleasant in a conventional sense. NOT hard-edged Surrealism like Dalí.",
        "palette_guidance": "Warm ochres, burnt sienna, deep reds, raw umber as ground tones. Vivid unexpected accents: acid green, cerulean blue, cadmium yellow breaking through earth layers. Colors feel excavated — warm depth with cool surface disruptions.",
    },
    "willem_de_kooning": {
        "description": "Willem de Kooning — Abstract Expressionist gestural painting of visceral, aggressive energy. Slashing, dragged brushstrokes of flesh tones, pinks, yellows, and blacks colliding. Fragmentary figuration dissolving into pure paint. The paint itself is the subject — thick, flung, dragged across the surface with physical force. Raw sexuality and urban electricity.",
        "weather_mapping": "Wind speed is PRIMARY — strong wind = violent slashing marks, aggressive diagonals cutting across the surface; calm = broader fluid passages with color flowing. Temperature drives the palette — heat = vivid flesh pinks, cadmium yellows, oranges of the Women series; cold = greys, blacks, and icy whites of the urban palette. Pressure creates spatial compression — low pressure = forms pressing aggressively against the picture plane; high pressure = openings of ground showing through slashed marks. Precipitation adds pools and runs of diluted color cutting through thick impasto.",
        "negative": "NOT geometric, NOT controlled, NOT soft, NOT spiritual, NOT photorealistic, NOT minimal. This should feel AGGRESSIVE and physical — paint flung and dragged with bodily force. No peaceful or meditative passages. NOT illustrative.",
        "palette_guidance": "Flesh pinks, cadmium yellow, viridian green, ivory black, titanium white. Passages of vivid high-chroma color colliding. Alizarin crimson and raw umber as grounding tones. Clashing warm-cool combinations at every juncture.",
    },
    "joan_mitchell": {
        "description": "Joan Mitchell — lyrical Abstract Expressionist evoking memory and landscape through dense gestural clusters. Vibrant brushwork references nature (gardens, water, fields, light) without depicting it. Marks accumulate in energetic groupings against open luminous ground. Exuberant, emotionally direct, deeply felt. Her paintings are memories of sensation, not records of place.",
        "weather_mapping": "Temperature drives color intensity — heat = saturated summer palette (cadmium yellow, viridian, cobalt); cold = steely blues, greys, winter whites with cool shadow tones. Precipitation maps directly to brushstroke density — rain = dense overlapping clusters; dry = more open gestural passages with breathing room. Wind creates directional energy — strong wind = elongated diagonal marks suggesting movement through fields; calm = rounded cluster-like marks that gather and bloom. Pressure maps to ground luminosity — low pressure = dense dark ground; high pressure = open luminous ground showing through.",
        "negative": "NOT geometric, NOT hard-edged, NOT illustrative, NOT photorealistic, NOT sparse. No recognizable landscape elements — this is emotional response to nature, not depiction. NOT thin or delicate — Mitchell's paint is characteristically loaded, physical, and present.",
        "palette_guidance": "Saturated greens (viridian, sap green), cobalt and cerulean blues, cadmium yellows, titanium white. Occasional warm passages (cadmium red, cadmium orange). Pale luminous ground visible through color clusters. Colors are vivid and uncompromised — Mitchell never muddied her hues.",
    },
    "mark_tobey": {
        "description": "Mark Tobey — 'white writing' technique of dense calligraphic marks creating luminous all-over compositions. Networks of white, cream, and silver lines on dark grounds, influenced by East Asian calligraphy and Bahá'í mysticism. Teeming microscopic energy suggesting city crowds, cosmic networks, or spiritual light streaming through darkness. All-over composition with no focal hierarchy — every inch equally alive.",
        "weather_mapping": "Wind speed directly drives writing density — strong wind = tightly packed calligraphic marks filling the entire surface; calm = sparser marks with dark ground breathing between them. Temperature maps to the ground tone — heat = warm dark grounds (brown-black, burnt umber) with warm white marks; cold = cool dark grounds (blue-black, charcoal) with silvery-cool marks. Pressure maps to mark scale — low pressure = larger, bolder writing gestures; high pressure = microscopic marks at maximum density. Humidity controls luminosity — high humidity = marks pulse and glow with inner light.",
